        ...
        <div className="flex flex-col min-h-screen bg-(--bg)">
            ...
            <main className="flex flex-1 flex-col items-center content-center gap-2 bg-(--bg-dark)">
                ...
                <section className="lg:flex justify-evenly items-center gap-4 min-h-75 h-auto w-full p-10 bg-(--bg-dark)">
                    ...
                    <div  className='flex flex-col lg:flex lg:flex-row lg:gap-4 lg:items-center '>
                        ...
                        <a href="mailto:kodymrwood14@gmail.com" target="_blank" className="text-xl lg:text-2xl text-(--text-muted) mt-4">kodymrwood14@gmail.com</a>
                    </div>



                    <div  className='flex flex-col lg:flex lg:flex-row lg:gap-4 lg:items-center mt-10'>
                        ...
                        <a href="https://www.linkedin.com/in/kody-mr-wood" target="_blank" className="text-2xl text-(--text-muted) mt-4">LinkedIn</a>
                    </div>
                </section>
