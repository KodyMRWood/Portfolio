...
function NavigationBar()
{
    const dropDownOptions = [
        <DrowndownItem> {<Link to="/game-dev" className="navlink " key="gamedev">Game Dev</Link>} </DrowndownItem>,
        <DrowndownItem> {<Link to="/web-dev" className="navlink " key="webdev">Web Dev</Link>} </DrowndownItem>,
    ]
    return (
        <>
        <nav className=
