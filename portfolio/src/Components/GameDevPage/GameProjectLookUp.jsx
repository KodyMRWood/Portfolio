...
const GameProjectsLookUp = {
    "Barbie Dreamhouse Adventures": {
        ...
        longDescription:"A Budge Studios  game that allows players to customize Barbie and Friends and the Dreamhouse. There are several locations from the Barbie universe where players can interact with objects and role play with characters. Similar to how Barbies are played in real life.",
        ...
        responsibilities:[
            ...
            "Used Jira and Agile to track progress and resolve blockers for +35 2-week sprints, resulting in fast iterable development",
            "Utilized Unity ScriptableObjects to store and manage large amounts of data for use in +100 Unity components",
            "Made use of Addressables to improve loading and game download size by +3Gb",
    ...
    "Barbie Magical Fashion": {
        ...
        longDescription:"A Budge Studios game that lets players pick a Barbie they would like to customize and allowing them to play through a series of dress-up stages to make their perfect doll. These stages include hair, make-up and shoes. Their final product is then saved in a gallery for them to look at or share with friends.",
        shortDescription:"Revamped Mobile Game",
        img: BMFImg,
        videoLink:"https://www.youtube.com/embed/dqKC_S_34gc?si=7DgAAgsMYfl5YFmz",
        responsibilities:[
            "Revamped 10-year-old project using Unity, C# and design patterns to improve gameplay, resulting in +70,000 downloads a month since re-release",
            "Solved game breaking bug causing a region of players from playing the game",
            "Developed gameplay stages using OOP to create a reusable and extensible code base, improving development time by 89%",
    ...
    "Lunch Boxing": {
        title:"Lunch Boxing",
        longDescription:"A game in development by Butterware Studios (Under NDA). It is a game that pays homage to older fighting games like Mike Tyson's Punch Out.",
        ...
        responsibilities:[
            ...
            "Employ YARN to create interactive dialogue for the game"
        ],
    ...
    "Physiological Adaptive Module": {
        ...
        longDescription:"A Virtual Reality adaptive module that creates a connection between a BITalino and Unity. Additionally, it contains template scripts that help create adaptive game elements in any Unity Project. The system uses the users' heart rate and skin conductivity readings to determine if there is a significant level of stimulus. If the user had elevated measures, the module adapts the simulation to create a less stimulating environment. This is, ultimately, to assist in making Virtual Reality more usable. The module was tested in a training scenario for nuclear engineers safety protocol.",
        shortDescription:"Master's dissertation module",
        img: PAM,
        videoLink:"",
        responsibilities:[
            "Developed adaptive module that reads user's physiological measures ",
            "Successfully create Unity training simulation that changes difficulty based on the user's stress",
            "Created a system that stores +1000 data points per second using CSV",
    ...
    "Project Olympus": {
        ...
        longDescription:"A project that made using Unreal to utilize C++ and learn Unreal. The final project has enemy AI, Inverse Kinematics (IK), object interactions, animation blending and sound integrated",
        shortDescription:"Solo project made Unreal",
        img: ProjectOlympus,
        videoLink:"",
        responsibilities:[
            "Developed an IK for the main player using Blueprint and C++ to create an immersive experience",
            "Integrated game mechanics for picking up loot and fighting enemy units",
            "Implemented animation graphs, transitions and triggering with Unreal's animation system",
            "Created patrolling AI units that change logic states upon detecting player"
        ],
    ...
    "Orbit": {
        title:"Orbit",
        longDescription:"Mobile release developed with Google Admob.The game was originally developed for TOJam 2022:All Twogether Now with the theme 'That Shouldn't Be Here'. The game was then expanded to have Google AdMob and released on Android and iOS.",
        ...
        responsibilities:[
            ...
            "Utilized interstital and banner ads obtaining more than $1.00 CAD of earnings"
        ],
        tech:[Unity, CSharp, VisualStudio, GitHub],
    ...
    "Postal Panic": {
        title:"Postal Panic",
        longDescription:"Ludum Dare 53 with the theme of 'Delivery'. There are tons of packages that come through our Postal Office everyday, and we need your help more than ever! Make sure the packages have the right postage to get them where the customer needs!",
    ...
    "Downroot": {
        title:"Downroot",
        longDescription:"Global Game Jam 2023 submission with the theme of 'Roots'. You are a small plant that is eventually going to run out of water and wither. Find water on your way to the center of the Earth to keep replenished for the long journey down. Make sure to avoid rocks in your path and see if you can make it to the infinite pool!",
    ...
    "Meteor Mayhem": {
     ...
     "Tactile": {
        ...
        videoLink:"",
        responsibilities:[
            "Integrated deck and card mechanics including shuffling, dealing and cards in hand display",
            "Implemented sounds to add auditory feedback and ambiance to the game",
    ...
    "Project Aeromail": {
        ...
        responsibilities:["Implemented flying mechanics, creating a fun way of experiencing the game world",
            ...
            "Made use of Unity URP and Shader effects to create postprocessed areas of the map to increase player immersion",
    ...
    "Ship Scavenger": {
        ...
        longDescription:"GMTK Game Jam 2020 submission with the theme of 'Out of Control'. Your ship has blown up, and you're left with only an engine. Travel around the asteroid field collecting and putting your ship back together along the way. Search for your star drive to escape and return home.",
        shortDescription:"GMTK Game Jam 2020 Submission",
        img: ShipScavenger,
        videoLink:"",
        responsibilities:[
            "Integrated player movement of the ship and the player character",
            "Implemented sounds to add auditory feedback and ambiance to the game",
        ],
        tech:[Unity, CSharp, VisualStudio, GitHub],
        workLink:"",
    ...
    "MORPPP": {
        title:"MORPPP",
        longDescription:"A capstone project built by the Faculty of Engineering and Applied Science and Faculty of IT and Business. This project displays a mathematically accurate model of a radiative plume being released over a populated city. The purpose was to use VR, an emerging technology, to bring awareness to the safety procedures  for if this situation were to occur.",
        ...
        responsibilities:[
            ...
            "Integrated human-VR interactions, allowing users to move around the virtual world",
    ...
    "Augmented Reality Story Book": {
        ...
        longDescription:"This application is an AR simulation on mobile devices that scans pictures on a picture book and displays a 3D animated scene on a mobile device. Additionally, words are also displayed upon scanning the image. Once pressed, the animated scene which performs the next animation, plays along as you read. The purpose of the application is to assist kids in learning to read, by giving them a fun and interactive way of reading books.",
    ...
    "Scrapper Dome": {
        title:"Scrapper Dome",
        longDescription:"2 players are thrown into one vehicle to battle in a futuristic gladiator-style colosseum. One player drives, the other fires a mounted turret. Their enemy? A giant robot and its smaller robot army. Work together to take out the drones and defeat the robot in an epic showdown. ",
        shortDescription:"Co-op arena brawler 3rd year project",
        img: ScrapperDome,
        videoLink:"https://www.youtube.com/embed/9rbIJ_txK3E",
        responsibilities:[
            "Integrated environmental hazards to bring life the game world",
            "Implemented AI logic to chase players after spawing",
            "Led and collaborated with a team of 7 people to successfully develop a co-op game",
    ...
    "Slimeball": {
        title:"Slimeball",
        longDescription:"Slimeball is a 4-player couch arcade game that has players fight in an arena as balls of slime. Try to be the last one standing, by throwing pieces of yourself at other players. If you hit, a large chunk will be available to pick up, which on collecting will give you back more health. But be careful as shooting means you lose health, and size.",
        shortDescription:"4 player shooter: 2nd year project",
        img: SlimeballImg,
        videoLink:"https://www.youtube.com/embed/CwsqdhDy0mU",
        responsibilities:[
            "Chosen to represent my school at Level Up Showcase 2017",
            "Utilized OpenGL and C++ to integrate a deferred rendering solution allowing",
            "Lead team of 7 as project lead to develop a game that was invited to showcase at the Toronto LevelUp Showcase",
    ...
    "Celestial": {
        title:"Celestial",
        longDescription:"This is my first year project where players play three characters; a thief, a blacksmith, and a hero. Each character has a special ability that the player can utilize to solve various parts of a puzzle.",
        ...
        responsibilities:[
            ...
            "Led team of 5 people successfully developing a game that was chosen to represent school at the Level Up Showcase 2016",
