...
function PageTitleSection({header, description, children}) {
  return (
    <section className='w-full bg-(--bg) px-4 sm:px-10 shadow-md items-center'>
      <div className='mx-auto py-15 lg:py-20 lg:flex lg:flex-row lg:max-w-[80%] lg:gap-10 text-left'>
        ...
        <img src={headshot} className='rounded-2xl max-w-full h-auto max-h-100 mt-10 lg:max-h-75 lg:m-0 self-center'></img>
      </div>
      {children}
    </section>
  )
